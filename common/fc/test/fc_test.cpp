...
BOOST_AUTO_TEST_CASE(test_zip) try {
  {
    ...
    auto zip_ret = fc::zlib_compress(source);
    auto unzip_str = fc::zlib_decompress(zip_ret);
...
BOOST_AUTO_TEST_CASE(test_https_get) try {
  using namespace fc::https;
  fc::https::https hs("xueqiu.com","443","/S/SH513500");
...
BOOST_AUTO_TEST_CASE(test_https_async_post) try {
  ...
  log_throw("test_https_async_post test");
